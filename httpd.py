...
#
"""This web server has been modified to fit in this project.
   please change SAFE_DIR_COMPONENTS to the directory the project is in and do 
   "#mv httpd.py ../"before funning
"""
...
SAFE_DIR_COMPONENTS = ['chromeProjects'];
